...
VALUES
  ...
  (1, 'Garlic Powder', 'tbsp', 1/2),
  (1, 'Onion Powder', 'tbsp', 1/2),
  (1, 'Oyster Mushrooms', 'lb', 1),
  (2, 'Medium Kohlrabi', 'head', 1),
  (2, 'Egg (Vegan option: 1/4 cup AP Flour + 1/3 cup water)', 'tsp', 1/2),
  (2, 'Smoked Paprika', 'tsp', 1/2),
  (2, 'Salt', 'tsp', 1/2),
  (2, 'Poultry Seasoning, optional', 'tsp', 1),
  (2, 'Bread Crumbs', 'cup', 1/2),
  (2, 'Smoked Paprika', 'tsp', 1/2),
  (2, 'Salt', 'tsp', 1/2),
  (2, 'Crushed Oats', 'tbsp', 1),
  (2, 'Oil', 'tbsp', 2),
  (3, 'Medium Eggplant, cut into 1/2 inch chunks', 'each', 1),
  (3, 'Long Beans, cut into 2-3 inch pieces', 'oz', 8),
  (3, 'White Onion, medium diced', 'each', 1/2),
  ...
  (4, 'Garlic Powder, more to taste', 'tsp', 1/2),
  (4, 'Ground Red Pepper, more to taste', 'tsp', 1/2),
  (4, 'Salt, more to taste', 'tsp', 1/2),
  (4, 'Leftover Turkey', 'lb', 2),
  (4, 'Oil', 'cup', 1/2),
  (4, 'Andouille Sausage, chopped', 'lb', 1/2),
  ...
  (6, 'Red Pepper Flakes', 'tsp', 1/4),
  (6, 'Salt & Pepper', 'tsp', 1/4),
  ...
  (8, 'Maple Syrup', 'tbsp', 1/2),
  (8, 'Brown Sugar', 'tbsp', 1/2),
